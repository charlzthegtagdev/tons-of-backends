handlers.ReturnCurrentVersionNew = function(args){
    return {"ResultCode":0,"BannedUsers":"1","MOTD":"<color=red>HELLO, WELCOME TO MONKE TAGGERS!</color>\n<color=cyan>NEW DISCORD SOON!</color>\n<color=lime>UPDATE IS: SPRING 23</color>\n<color=magenta>YOUR ID: " + currentPlayerId + "</color>\n<color=green>OWNERS ARE MONKE, NOTUNKOWN AND LOI</color>","SynchTime":"-LOADING-","Version":"live1.1.1.29", "Message":"live1.1.1.29"}
}
hostids = "ADDF3AB9625AA6F2"
gamedown = false
