...
class GameInfo:
    def __init__(self):
        self.TitleId = "352E6"  # Combined from Attachment 0
        self.SecretKey = "BBBIF1OMXH85BF4XYJP5PQE3TF5BNBPWFMOI78XDJ75KRHO3BR"  # From Attachment 0
        self.ApiKey = "OC|9265699206870617|04c28f5f8dffb8d787274f0a6de4ace0"  # From Attachment 0
...
item_names = ["", ""]  # Placeholder, expand as needed
