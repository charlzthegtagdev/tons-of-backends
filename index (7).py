...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "C45C1"
        self.SecretKey : str = "TCF7RW8A55IA1K4H94XU31SSSMGM5XHUDREMQK9ARCZPJ8GAPU"
        self.ApiKey : str = "OC|23982138708045772|5823d73fcdae37604118979d824eebd0"
